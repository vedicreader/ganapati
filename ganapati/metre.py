...
# %% auto #0
__all__ = ['GANAS', 'METERS', 'VRTTA_EXTRA', 'MATRA_METERS', 'CATURMATRA', 'Meter', 'PADA_RANGE', 'deva2iast', 'syllables',
           'scan', 'ganas', 'gana_pattern', 'metrical_text', 'matras', 'detect_matra_meter', 'detect_meter',
